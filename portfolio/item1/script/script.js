...
(function () {
	var navBox = document.querySelector('.dropdown-nav-box');
	var closeTab = document.querySelector('.dd-close-tab');
	var openTab = document.querySelector('.fa-bars');
		openTab.addEventListener('click', function thisFunc() {
				navBox.style.display = 'block';
		}, false);
		closeTab.addEventListener('click', function thatFunc() {
...
$(document).ready(function() {
	...
	Slider.prototype.buildSlider = function() {
		$('<div class="widget-slider"><ul class="widget-slider-nav"><div class="widget-slider-pointer"></div><li class="widget-slider-nav1"></li><div class="widget-slider-pointer"></div><li class="widget-slider-nav2"></li><div class="widget-slider-pointer"></div><li class="widget-slider-nav3"></li><div class="widget-slider-pointer"></div><li class="widget-slider-nav4"></li></ul><div class="widget-slider-show"><ul class="widget-slider-wrap"><li class="widget-slider-img"><img src="img/bg-hn.jpg" alt=""></li><li class="widget-slider-img"><img src="img/bg-hn.jpg" alt=""></li><li class="widget-slider-img"><img src="img/bg-hn.jpg" alt=""></li><li class="widget-slider-img"><img src="img/bg-hn.jpg" alt=""></li></ul></div></div>').appendTo(this.node);
	...
	Slider.prototype.autoStartSlider = function() {
		this.clearPointer();
		this.showPointer();
		this.shift = setInterval(this.autoShiftImages.bind(this), 5000);
	};
